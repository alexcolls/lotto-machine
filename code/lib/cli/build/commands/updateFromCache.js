...
async function updateMetadataFromCache(candyMachineAddress, connection, wallet, batchSize, cacheContent, newCacheContent) {
    ...
    const metadataByCandyMachine = await (0, signAll_1.getAccountsByCreatorAddress)((await (0, accounts_1.getCandyMachineCreator)(new web3_js_1.PublicKey(candyMachineAddress)))[0].toBase58(), connection);
    const differences = {};
